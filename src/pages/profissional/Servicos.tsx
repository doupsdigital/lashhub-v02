              ...
              {cat.servicos.length === 0 ? (
                ...
                <div className="divide-y divide-border bg-white rounded-b-[14px]">
                  {cat.servicos.map(serv => (
                    <div 
                      key={serv.id} 
                      className={`px-6 py-2 flex flex-col sm:flex-row sm:items-center justify-between gap-2 transition-colors duration-150 hover:bg-bg/10 last:rounded-b-[14px] ${!serv.ativo ? 'opacity-50' : ''}`}
                    >
                      {/* Left: Info */}
