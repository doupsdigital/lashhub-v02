...
function HelpButtonInner({ pageKey }: { pageKey: OnboardingPageKey }) {
  ...
  return (
    <button
      ...
      className="fixed right-4 z-50 flex items-center gap-1.5 px-3 py-2 bg-white border border-border rounded-full shadow-md text-text-secondary hover:text-rose-600 hover:border-rose-300 text-xs font-medium transition-all hover:shadow-lg cursor-pointer md:bottom-6"
